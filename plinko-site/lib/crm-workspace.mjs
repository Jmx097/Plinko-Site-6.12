...
export const CRM_ACTIONS = {
  ...
  gmail_export_claim: { method: 'POST', path: (p) => `/crm/drafts/${encodeURIComponent(p.draft_id)}/gmail-export/claim` },
  gmail_export_complete: { method: 'POST', path: (p) => `/crm/drafts/${encodeURIComponent(p.draft_id)}/gmail-export/complete`, fields: ['gmail_draft_id'] },
